    ...
    },
    {
      ...
      render: (member: Member) => (
        <span className={`font-bold ${
          (member.creditScore || 0) >= 80 ? 'text-green-600' :
          (member.creditScore || 0) >= 50 ? 'text-amber-600' : 'text-red-600'
        }`}>
          ...
          >
            ...
            <div className="p-4 space-y-4">
              ...
              <div className="space-y-3">
                ...
                <DetailRow label="Credit Score" value={selectedMemberMobile.creditScore || 0} />
                <DetailRow 
                  label="Status" 
                  value={
                    <span
              ...
              {role === "ADMIN" && (
                <div className="flex gap-2 pt-4">
                  ...
                  <button
                    onClick={() => {
                      handleDelete(selectedMemberMobile);
                      setSelectedMemberMobile(null);
                    }}
